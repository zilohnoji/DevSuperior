...
public class MovieFactory {
    ...
    public static MovieEntity createMovieEntity(Long id, String title) {
        MovieEntity movie = new MovieEntity(id, title, 0.0, 0, "https://www.themoviedb.org/t/p/w533_and_h300_bestv2/jBJWaqoSCiARWtfV0GlqHrcdidd.jpg");
        return movie;
    }
    ...
    public static MovieDTO createMovieDTO(String imgUrl) {
        MovieEntity movie = createMovieEntity();
